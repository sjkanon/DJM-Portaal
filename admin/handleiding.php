                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <?php handleiding_figuur('beheer-instellingen-portaal', 'Instellingen: portaal', [
                            'bijschrift' => 'Portaal: naam, merkkleur, logo, welkomsttekst en contactadres. Een geüpload logo (PNG, JPEG, WEBP of SVG) komt buiten de webmap te staan en wordt door het portaal zelf uitgeleverd. Zet "Portaal ingeschakeld" uit tijdens onderhoud: dan kan niemand een code aanvragen.',
                        ]); ?>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="djm-hl-tekst">
                ...
                <ul>
                    ...
                    <li><strong>Een nieuw wachtwoord logt overal uit:</strong> zodra iemand via zo'n link een nieuw
                        wachtwoord kiest, vervallen alle beheersessies die op dat account openstonden — ook op een andere
